...
So changing "poly1305_auth" to "poly1305_auth_floodyberry" in reference implementation
*/
void poly1305_auth_floodyberry(unsigned char out[16], const unsigned char *m, size_t inlen, const unsigned char key[32]) { //CHANGE (poly1305_auth -> poly1305_auth_floodyberry)
...
FUZZ_TARGET(crypto_poly1305_differential_fuzz)
{
